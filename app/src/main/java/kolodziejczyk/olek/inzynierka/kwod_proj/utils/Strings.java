package kolodziejczyk.olek.inzynierka.kwod_proj.utils;

/**
 * Created by Patka on 2017-05-15.
 */
...
public class Strings {
    ...
    public static final String omdlenie2="4. Położ poszkodowanego na plecach i udrożnij drogi oddechowe poprzez odgięcie głowy do tyłu.";
    public static final String omdlenie3=" 5. Sprawdź czy poszkodowany oddycha. \n" +
            "W czasie 10 sekund powinniśmy zaobserwować co najmniej 2 oddechy.";
    public static final String omdlenie4="6. Jeśli poszkodowany nie oddycha przejdź do resuscytacji krążeniowo - oddechowej.\n" +
            "Jeśli poszkodowany oddycha unieś nogi poszkodowanego do góry.\n";
    public static final String omdlenie5= "NIE NALEŻY:\n" +
    ...
    public static final String rko1="Połóż poszkodowanego na plecach, odchyl jego głowę do tyłu, aby udrożnić drogi oddechowe.";
    public static final String rko2="Sprawdź czy poszkodowany oddycha.\n" +
    ...
    public static final String rko3="Wykonaj 30 uciśnieć klatki piersiowej.";
    public static final String rko4="Wykonaj dwa wdechy.\n" +
    ...
    public static final String boczna1="1. Rękę bliższą Tobie ułóż pod kątem prostym w stosunku do ciała," +
            " a następnie zegnij w łokciu pod kątem prostym z dłonią skierowaną do góry.\n";
    public static final String boczna2="2. Drugą rękę poszkodowanego przytrzymaj przy policzku wnętrzem dłoni na zewnątrz.";
    public static final String boczna3="3. W tym samym momencie złap za nogę leżącą dalej od siebie za kolano i pociągnij ją ku górze.";
    ...
    public static final String zlamanie6="NIGDY\n" +
            "Nigdy nie nastawiaj złamanych, zwichniętych lub skręconych kończyn.\n" +
